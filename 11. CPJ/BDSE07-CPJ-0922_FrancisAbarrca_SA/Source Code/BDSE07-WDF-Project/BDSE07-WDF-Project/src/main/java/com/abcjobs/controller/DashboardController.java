...
public class DashboardController {
	...
	@RequestMapping(value="/job") // Job Overview
	public ModelAndView job(HttpSession session, Model model) throws Exception {
	    try {
	        this.setModel(model, session);
	        return new ModelAndView("jobs/job");  
	    } catch (Exception e) {
	...
	@RequestMapping(value="/thread") // Job Overview
	public ModelAndView thread(HttpSession session, Model model) throws Exception {
	    try {
	        this.setModel(model, session);
	        return new ModelAndView("threads/threads");  
	    } catch (Exception e) {
	        System.out.println(e);
	        String msg = "Login required";
	        model.addAttribute("message", msg);
	...
	@RequestMapping(value="/feedback") // Job Overview
	public ModelAndView feedback(HttpSession session, Model model) throws Exception {
