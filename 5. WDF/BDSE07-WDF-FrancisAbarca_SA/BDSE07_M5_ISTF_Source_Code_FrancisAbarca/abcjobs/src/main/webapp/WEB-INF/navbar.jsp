          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link <%= request.getServletPath().equals("/WEB-INF/views/index.jsp") ? "text-danger"
                  : "text-white" %>" href="home" style="margin-right: -4px;">Home</a>
            </li>
            <li class="nav-item">
            ...
            <% if((Boolean) session.getAttribute("isLogin") != null) { %>
                <li class="nav-item">
                  <a class="nav-link <%= request.getServletPath().equals("/WEB-INF/views/dashboard/index.jsp")
                    ? "text-danger" : "text-white" %>" href="dashboard" style="margin-left: 2px;">Dashboard</a>
                </li>
                <% } %>
            </ul>
            <% if((Boolean) session.getAttribute("isLogin") != null) { %>
            	<li class="nav-item">
                    ...
                    ? "text-danger" : "text-white" %>" href="profile" style="margin-left: -21px;">Profile</a>
                </li>
                <% } %>
            <% if((Boolean) session.getAttribute("isLogin") != null) { %>
              <li class="nav-item">
