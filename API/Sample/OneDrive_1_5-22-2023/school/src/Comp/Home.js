...
<div class="top_container">
      ...
      <div class="hero-container container">
        <div class="hero_detail-box">
          ...
          <div class="hero_btn-continer">
            <a href="home" class="call_to-btn btn_white-border">
              Read More
            </a>
          </div>
        </div>
        <div class="hero_img-container">
          <div>
            <img src="assests/images/hero.png" alt="" class="img-fluid"/>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="about_img-container">
              <img src="assests/images/about.png" alt=""/>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="admission_img-container">
              <img src="assests/images/admission.png" alt=""/>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="why_img-container">
              <img src="assests/images/why.png" alt=""/>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="determine_img-container">
              <img src="assests/images/determine.png" alt=""/>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="row">
                      <div class="col-md-3">
                        <div class="client_img-box">
                          <img src="assests/images/client.png" alt=""/>
                        </div>
                      </div>
                      <div class="col-md-9">
  ...
  <script type="text/javascript" src="assests/js/jquery-3.4.1.min.js"></script>
