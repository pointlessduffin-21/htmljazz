    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="StoreManager">Manage</a></li>
            </ul>
        </div>
    </div>
</nav>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${all_Stores}" var="u">
                            <tr>
                                ...
                                <td><c:forEach var="location" items="${u.getLocalities()}">
                                    <span> ${location}</span>
                                </c:forEach></td>
                                <td>
                                    <a class="pr-5" href="addMoreStore" style="text-decoration: none;">Add</a>
                                    <a href="home" style="text-decoration: none;">Home</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
