    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="CreateStore">Add</a></li>
...
<main class="page landing-page">
    <section class="clean-block clean-hero" style="color: rgba(31,28,140,0.35);background: url(https://gpupv.yeems214.xyz/R%20e%20p%20o%20s%20i%20t%20o%20r%20y/assets/img/OIG.jpg) center / cover space;">
        <div class="text">
            ...
            <p>With Know Your Neighborhood, we help you find the utmost special businesses and infrastructures available in your community!</p><a  href="CreateStore"><button class="btn btn-outline-light btn-lg" type="button">Add your business</button></a>
        </div>
    </section>
</main>
