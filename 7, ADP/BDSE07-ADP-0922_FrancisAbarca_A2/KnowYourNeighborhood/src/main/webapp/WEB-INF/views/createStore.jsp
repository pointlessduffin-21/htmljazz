    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="CreateStore">Add</a></li>
                <li class="nav-item"><a class="nav-link" href="StoreManager">Manage</a></li>
            </ul>
        </div>
    </div>
</nav>
<main class="page contact-us-page">
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form class="p-5" d="storeForm" modelAttribute="store" action="saveStore" method="post">
                <div class="mb-3">
                    <label class="form-label" for="name" path="name">Store Name</label>
                    <input class="form-control" type="text" aria-describedby="storeHelp" name="name"
                           placeholder="Enter store name" path="name">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="phone_number" path="phone_number">Phone Number</label>
                    <input class="form-control" type="text" name="phone_number"
                           path="phone_number" placeholder="Enter phone number">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="localities" path="localities">Store Location</label>
                    <input class="form-control" type="text" name="localities" path="localities" placeholder="Enter store location">
                </div>
                <div class="mb-3">
