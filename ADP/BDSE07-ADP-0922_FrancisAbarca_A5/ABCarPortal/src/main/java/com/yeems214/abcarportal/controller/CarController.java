package com.yeems214.abcarportal.controller;
...
import com.yeems214.abcarportal.service.CarService;
import com.yeems214.abcarportal.service.UserService;
...
public class CarController {
    ...
    @GetMapping("home")
    public ModelAndView home(@ModelAttribute("landingPage") Car car) {
            return new ModelAndView("landingPage");
    }

    @GetMapping("cars")
    public ModelAndView index(@ModelAttribute("car") Car car) {
    ...
    public String carBidding(@ModelAttribute("bidding") CarBidding bid,
        ...
        // Check if user has already bid on the car
