...
public class Profile {
    ...
    public Profile(Long id, String firstName, String lastName, String fullName, String title, String about, String company, String email, String website, List<Experiences> ex, List<Educations> ed) {
        super();
        this.id = id;
